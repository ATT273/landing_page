...
const Footer = () => {
    return (
        <footer className='flex flex-col text-black-100 mt-5 border-t border-gray-100'>
            ...
            <div className='flex justify-between items-center mt-10 flex-wrap border-t border-gray-100 sm:px-16 px-6 py-6'>
                <p>@2023</p>
                <div className='footer__copyrights-link'>

                    <Link href={'/'} className='text-gray-500'>Policy</Link>
